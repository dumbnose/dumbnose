...
//
//	The verbose implementation has been replaced with a version that uses
...
#define ON_BLOCK_EXIT /*lint -save -e529 */softricity::shared::scope_guard ANONYMOUS_VARIABLE(scopeGuard) = softricity::shared::make_guard/*lint -restore */
...
namespace softricity { namespace shared {
...
#define BOOST_PP_ITERATION_LIMITS (0, MAX_SCOPE_GUARD_PARAMS)
#define BOOST_PP_FILENAME_1       "scope_guard_iter.hpp"
#include BOOST_PP_ITERATE()

}}  // namespace softricity::shared
